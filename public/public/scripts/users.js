      ...
      $stateProvider
        ...
        templateUrl: '../views/userView.html',
            ...
            // You can pair a controller to your template. There *must* be a template to pair with.
                controller: ['$scope', '$state', '$auth', 'users', 'utils',
                function (  $scope,  $state, $auth, users, utils) {
        ...
        /////////////////////
            ...
            .state('users.detail', {
              ...
              views: {
                      ...
                      $scope.dropzoneConfig = {
                          ...
                          'eventHandlers': {
                            'sending': function (file, xhr, formData) {
                              console.log('sending');
                              formData.append('userId', $stateParams.userId);
                            },
                ...
                'hint@': {
                  template: 'This is user-detail populating the "hint" ui-view'
                },
                ...
                'menuTip': {
                  ...
                  templateProvider: ['$stateParams',
                    function (        $stateParams) {
                      ...
                      return '<hr><small class="muted">Contact ID: ' + $stateParams.userId + '</small>';
                    }]
                }
              }
            }
        ...
        .state('users.detail.item', {
          ...
          views: {
            ...
            '': {
              templateUrl: '../views/users-detail.item.html',
        ...
        .state('users.detail.item.edit', {
          views: {
            ...
            '@users.detail': {
              templateUrl: '../views/users-detail.item.edit.html',
              controller: ['$scope', '$stateParams', '$state', 'utils',
                function (  $scope,   $stateParams,   $state,   utils) {
                  $scope.item = utils.findById($scope.user.items, $stateParams.itemId);
                  $scope.done = function () {
